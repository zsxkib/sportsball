...
def _parse_openmeteo(
    ...
    hourly_df = pd.DataFrame(
        ...
        data={
            ...
            "vapour_pressure_deficit": hourly.Variables(20).ValuesAsNumpy()[:row_count],  # type: ignore
            ...
            "soil_temperature_6cm": hourly.Variables(34).ValuesAsNumpy()[:row_count],  # type: ignore
            "soil_temperature_18cm": hourly.Variables(35).ValuesAsNumpy()[:row_count],  # type: ignore
            "soil_temperature_54cm": hourly.Variables(36).ValuesAsNumpy()[:row_count],  # type: ignore
    ...
    daily_df = pd.DataFrame(
        ...
        data={
            ...
            "apparent_temperature_max": daily.Variables(3).ValuesAsNumpy()[:row_count],  # type: ignore
            "apparent_temperature_min": daily.Variables(4).ValuesAsNumpy()[:row_count],  # type: ignore
            ...
            "uv_index_clear_sky_max": daily.Variables(10).ValuesAsNumpy()[:row_count],  # type: ignore
            ...
            "shortwave_radiation_sum": daily.Variables(20).ValuesAsNumpy()[:row_count],  # type: ignore
    ...
    precipitation_probability = hourly_df.iloc[hourly_idx]["precipitation_probability"]  # type: ignore
    ...
    et0_fao_evapotranspiration = daily_df.iloc[daily_idx]["et0_fao_evapotranspiration"]  # type: ignore
