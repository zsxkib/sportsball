...
_CACHED_GEOCODES: dict[str, Any] = {
    ...
    "Target Center - Minneapolis, Minnesota - United States": SportsballGeocodeTuple(
        city="Minneapolis",
        state="MN",
        postal="",
        lat=44.979444,
    ...
    "United Center - Chicago, Illinois - United States": SportsballGeocodeTuple(
        city="Chicago",
        state="IL",
        postal="",
        lat=41.880556,
    ...
    "Golden 1 Center - Sacramento, California - United States": SportsballGeocodeTuple(
        city="Sacramento",
        state="CA",
        postal="",
        lat=38.580361,
