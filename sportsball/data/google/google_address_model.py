...
BRYCE_JORDAN_CENTER = SportsballGeocodeTuple(
    city="University Park",
    state="PA",
    postal="16802",
    lat=40.79578,
...
WINTRUST_ARENA = SportsballGeocodeTuple(
    city="Chicago",
    state="IL",
    postal="",
    lat=41.853611,
...
MULLETT_ARENA = SportsballGeocodeTuple(
    city="Tempe",
    state="AZ",
    postal="",
    lat=33.426667,
...
_CACHED_GEOCODES: dict[str, Any] = {
    ...
    "Carrier Dome, Syracuse, New York": CARRIER_DOME,
    ...
    "Mullett Arena, Tempe, Arizona": MULLETT_ARENA,
    ...
    "Empower Field at Mile High, Denver, CO, USA": EMPOWER_FIELD,
    ...
    "Southeastern Oklahoma College": SportsballGeocodeTuple(
        city="Durant",
        state="OK",
        postal="",
        lat=34.006389,
    ...
    "Chase Field, Phoenix, AZ, USA": CHASE_FIELD,
    ...
    "Morehead State University": SportsballGeocodeTuple(
        city="Morehead",
        state="KY",
        postal="",
        lat=38.189,
    ...
    "Oracle Park": SportsballGeocodeTuple(
        city="San Francisco",
        state="CA",
        postal="",
        lat=37.778611,
    ...
    "Wembley Stadium - Wembley, London - England": WEMBLEY_STADIUM,
    "Mullett Arena": MULLETT_ARENA,
