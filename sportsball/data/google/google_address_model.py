...
_CACHED_GEOCODES: dict[str, Any] = {
    ...
    "BOK Center - Tulsa, Oklahoma - United States": SportsballGeocodeTuple(
        city="Tulsa",
        state="OK",
        postal="",
        lat=36.152722,
    ...
    "Indianapolis, Indiana": SportsballGeocodeTuple(
        city="Indianapolis",
        state="IN",
        postal="",
        lat=39.768611,
    ...
    "Milwaukee, Wisconsin": SportsballGeocodeTuple(
        city="Milwaukee",
        state="WI",
        postal="",
        lat=43.05,
    ...
    "Houston, Texas": SportsballGeocodeTuple(
        city="Houston",
        state="TX",
        postal="",
        lat=29.762778,
    ...
    "Jackson, Mississippi": SportsballGeocodeTuple(
        city="Jackson",
        state="MS",
        postal="",
        lat=29.762778,
    ...
    "Portland, Oregon": SportsballGeocodeTuple(
        city="Portland",
        state="OR",
        postal="",
        lat=45.52,
    ...
    "Spokane, Washington": SportsballGeocodeTuple(
        city="Spokane",
        state="WA",
        postal="",
        lat=47.658889,
    ...
    "Youngstown, Ohio": SportsballGeocodeTuple(
        city="Youngstown",
        state="OH",
        postal="",
        lat=41.1,
    ...
    "San Diego, California": SportsballGeocodeTuple(
        city="San Diego",
        state="CA",
        postal="",
        lat=32.715,
    ...
    "Beasley Coliseum, Pullman, Washington": SportsballGeocodeTuple(
        city="Pullman",
        state="WA",
        postal="",
        lat=46.735,
    ...
    "KeyBank Center, Buffalo, New York": SportsballGeocodeTuple(
        city="Buffalo",
        state="NY",
        postal="",
        lat=42.875,
    ...
    "Alumni Hall (RI), Providence, Rhode Island": SportsballGeocodeTuple(
        city="Providence",
        state="RI",
        postal="02918",
        lat=41.84575,
    ...
    "St. Petersburg, Florida": SportsballGeocodeTuple(
        city="St. Petersburg",
        state="FL",
        postal="",
        lat=27.773056,
    ...
    "Cabot Center Gym, Boston, Massachusetts": SportsballGeocodeTuple(
        city="Boston",
        state="MA",
        postal="02115",
        lat=42.3396,
    ...
    "Pittsburgh, Pennsylvania": SportsballGeocodeTuple(
        city="Pittsburgh",
        state="PA",
        postal="",
        lat=40.439722,
    ...
    "Las Vegas, Nevada": SportsballGeocodeTuple(
        city="Las Vegas",
        state="NV",
        postal="",
        lat=36.167222,
    ...
    "Fort Wayne, Indiana": SportsballGeocodeTuple(
        city="Fort Wayne",
        state="IN",
        postal="",
        lat=41.088889,
    ...
    "Los Angeles, California": SportsballGeocodeTuple(
        city="Los Angeles",
        state="CA",
        postal="",
        lat=34.05,
    ...
    "Seattle, Washington": SportsballGeocodeTuple(
        city="Seattle",
        state="WA",
        postal="",
        lat=47.603889,
    ...
    "Baltimore, Maryland": SportsballGeocodeTuple(
        city="Baltimore",
        state="MD",
        postal="",
        lat=39.289444,
    ...
    "Greensboro, North Carolina": SportsballGeocodeTuple(
        city="Greensboro",
        state="NC",
        postal="",
        lat=36.05,
    ...
    "Elon, North Carolina": SportsballGeocodeTuple(
        city="Elon",
        state="NC",
        postal="",
        lat=36.126667,
    ...
    "Minneapolis, Minnesota": SportsballGeocodeTuple(
        city="Minneapolis",
        state="MN",
        postal="",
        lat=44.981944,
    ...
    "Greenville, South Carolina": SportsballGeocodeTuple(
        city="Greenville",
        state="SC",
        postal="",
        lat=34.844444,
    ...
    "Pensacola, Florida": SportsballGeocodeTuple(
        city="Pensacola",
        state="FL",
        postal="",
        lat=30.421308,
    ...
    "Washington, District of Columbia": SportsballGeocodeTuple(
        city="Washington",
        state="DC",
        postal="",
        lat=38.904722,
    ...
    "Cincinnati, Ohio": SportsballGeocodeTuple(
        city="Cincinnati",
        state="OH",
        postal="",
        lat=39.1,
    ...
    "Bronx, New York": SportsballGeocodeTuple(
        city="Bronx",
        state="NY",
        postal="",
        lat=40.837222,
    ...
    "Oxford, Ohio": SportsballGeocodeTuple(
        city="Oxford",
        state="OH",
        postal="",
        lat=39.5075,
    ...
    "Raleigh, North Carolina": SportsballGeocodeTuple(
        city="Raleigh",
        state="NC",
        postal="",
        lat=35.854167,
    ...
    "Natchitoches, Louisiana": SportsballGeocodeTuple(
        city="Natchitoches",
        state="LA",
        postal="",
        lat=31.693056,
    ...
    "Philadelphia, Pennsylvania": SportsballGeocodeTuple(
        city="Philadelphia",
        state="PA",
        postal="",
        lat=39.952778,
    ...
    "Ames, Iowa": SportsballGeocodeTuple(
        city="Ames",
        state="IO",
        postal="",
        lat=42.034722,
    ...
    "Dayton, Ohio": SportsballGeocodeTuple(
        city="Dayton",
        state="OH",
        postal="",
        lat=39.759444,
    ...
    "Columbus, Ohio": SportsballGeocodeTuple(
        city="Columbus",
        state="OH",
        postal="",
        lat=39.962222,
    ...
    "Reno, Nevada": SportsballGeocodeTuple(
        city="Reno",
        state="NV",
        postal="",
        lat=39.527222,
    ...
    "Buffalo, New York": SportsballGeocodeTuple(
        city="Buffalo",
        state="NY",
        postal="",
        lat=42.886389,
    ...
    "Eugene, Oregon": SportsballGeocodeTuple(
        city="Eugene",
        state="OR",
        postal="",
        lat=44.056389,
    ...
    "Baton Rouge, Louisiana": SportsballGeocodeTuple(
        city="Baton Rouge",
        state="LA",
        postal="",
        lat=30.4475,
    ...
    "Hempstead, New York": SportsballGeocodeTuple(
        city="Hempstead",
        state="NY",
        postal="",
        lat=40.704722,
    ...
    "Boston, Massachusetts": SportsballGeocodeTuple(
        city="Boston",
        state="MA",
        postal="",
        lat=42.360278,
    ...
    "Miami, Florida": SportsballGeocodeTuple(
        city="Miami",
        state="FL",
        postal="",
        lat=25.766667,
    ...
    "St. George, Utah": SportsballGeocodeTuple(
        city="St. George",
        state="UT",
        postal="",
        lat=37.075,
    ...
    "Long Beach, California": SportsballGeocodeTuple(
        city="Long Beach",
        state="CA",
        postal="",
        lat=33.768333,
    ...
    "Riverside, California": SportsballGeocodeTuple(
        city="Riverside",
        state="CA",
        postal="",
        lat=33.948056,
    ...
    "Pittsburgh Civic Arena, Pittsburgh, Pennsylvania": SportsballGeocodeTuple(
        city="Pittsburgh",
        state="PA",
        postal="15219",
        lat=40.441667,
    ...
    "Knoxville, Tennessee": SportsballGeocodeTuple(
        city="Knoxville",
        state="TN",
        postal="",
        lat=35.9617,
    ...
    "Charleston, South Carolina": SportsballGeocodeTuple(
        city="Charleston",
        state="SC",
        postal="",
        lat=32.783333,
    ...
    "Richmond, Virginia": SportsballGeocodeTuple(
        city="Richmond",
        state="VA",
        postal="",
        lat=37.540833,
    ...
    "Winston-Salem, North Carolina": SportsballGeocodeTuple(
        city="Winston-Salem",
        state="NC",
        postal="",
        lat=36.102778,
    ...
    "Daytona Beach, Florida": SportsballGeocodeTuple(
        city="Daytona Beach",
        state="FL",
        postal="",
        lat=29.210833,
    ...
    "New York, New York": SportsballGeocodeTuple(
        city="New York",
        state="NY",
        postal="",
        lat=40.712778,
    ...
    "Memphis, Tennessee": SportsballGeocodeTuple(
        city="Memphis",
        state="TN",
        postal="",
        lat=35.1175,
    ...
    "Peoria, Illinois": SportsballGeocodeTuple(
        city="Peoria",
        state="IL",
        postal="",
        lat=40.692778,
    ...
    "Chattanooga, Tennessee": SportsballGeocodeTuple(
        city="Chattanooga",
        state="TN",
        postal="",
        lat=35.045556,
    ...
    "Stockton, California": SportsballGeocodeTuple(
        city="Stockton",
        state="CA",
        postal="",
        lat=37.975556,
    ...
    "Nacogdoches, Texas": SportsballGeocodeTuple(
        city="Nacogdoches",
        state="TX",
        postal="",
        lat=31.63,
